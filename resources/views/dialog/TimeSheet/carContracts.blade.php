...
<form action="/timesheet/addContract" method="POST">
    @csrf
    <div class="modal-body">
        <input type="number" name="timeSheetId" value="{{$timeSheetObj->id}}" hidden/>
        @forelse ($contractsObj as $contract)
            <div class="row">
                ...
                <div class="col-1 text-right"><input type="radio" name="contractId" value="{{$contract->id}}"/></div>
            </div>
        @empty
