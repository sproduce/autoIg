...
<form method="POST" action="/document/storePayment">
    <input type="text" name="linkUuid" value="{{$paymentObj->uuid}}" hidden />
        ...
        <div class="container-fluid">
            <div class="form-row text-center">
                <div class="form-group col-md-4 input-group-sm">
                    ...
                    <input type="text" name="checkingAccount" id="checkingAccount" class="form-control" value="" required autocomplete="off"/>
                </div>
                <div class="form-group col-md-4 input-group-sm">
                    <label for="bankName" title="">Банк</label>
                    <input type="text" name="bankName" id="bankName" class="form-control" value="" required autocomplete="off"/>
                </div>
                <div class="form-group col-md-4 input-group-sm">
                    <label for="bankInn" title="">ИНН банка</label>
                    <input type="text" name="bankInn" id="bankInn" class="form-control" value="" required autocomplete="off"/>
                </div>
            </div>
            ...
            <div class="form-row text-center">
                <div class="form-group col-md-6 input-group-sm">
                    ...
                    <input type="text" name="bankBik" id="bankBik" class="form-control" value="" required autocomplete="off"/>
                </div>
                <div class="form-group col-md-6 input-group-sm">
                    <label for="correspondentAccount" title="к/сч">к/сч</label>
                    <input type="text" name="correspondentAccount" id="correspondentAccount" class="form-control" value="" required autocomplete="off"/>
                </div>
            </div>
            <div class="form-row text-center">
                <div class="form-group col-md-6 input-group-sm">
