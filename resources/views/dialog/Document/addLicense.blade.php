...
<form method="POST" action="/document/storeLicense">
    <input type="text" name="linkUuid" value="{{$licenseObj->uuid}}" hidden />
        ...
        <div class="container-fluid">
            <div class="form-row text-center">
                ...
                <div class="form-group col-md-4 input-group-sm">
                    ...
                    <input type="text" name="city" id="city" class="form-control" value="" required autocomplete="off"/>
                </div>
                <div class="form-group col-md-4 input-group-sm">
            ...
            <div class="form-row text-center">
                <div class="form-group col-md-3 input-group-sm">
                    ...
                    <input type="date" name="start" id="start" class="form-control" value="" required autocomplete="off"/>
                </div>
                <div class="form-group col-md-3 input-group-sm">
                    <label for="finish" title="">Дата окончания</label>
                    <input type="date" name="finish" id="finish" class="form-control" value="" required autocomplete="off"/>
                </div>
                <div class="form-group col-md-6 input-group-sm">
                    <label for="categories" title="">Категории</label>
                    <input type="text" name="categories" id="categories" class="form-control" value="" required autocomplete="off"/>
                </div>
