        ...
        <div class="container-fluid">
            <div class="form-row text-center">
             ...
             <div class="form-row text-center">
                <div class="form-group col-md-6 input-group-sm">
                    ...
                    <input type="text" name="englishName" id="englishName" class="form-control" value="{{$entityObj->englishName}}" required autocomplete="off"/>
                </div>
                <div class="form-group col-md-6 input-group-sm">
                    <label for="nameReg" title="">Наименование регистрирующего органа</label>
                    <input type="text" name="nameReg" id="nameReg" class="form-control" value="{{$entityObj->nameReg}}" required autocomplete="off"/>
                </div>
            </div>
            ...
            <div class="form-row text-center">
                ...
                <div class="form-group col-md-4 input-group-sm">
                    ...
                    <input type="text" name="ogrnip" id="ogrnip" class="form-control" value="{{$entityObj->ogrnip}}" required autocomplete="off"/>
                </div>
            </div>
            <div class="form-row text-center">
                <div class="form-group col-md-4 input-group-sm">
                    <label for="dateReg" title="">Дата государственной регистрации</label>
                    <input type="date" name="dateReg" id="dateReg" class="form-control" value="{{$entityObj->dateReg}}" required autocomplete="off"/>
                </div>
                <div class="form-group col-md-4 input-group-sm">
                    <label for="okved" title="">ОКВЭД</label>
                    <input type="text" name="okved" id="okved" class="form-control" value="{{$entityObj->okved}}" required autocomplete="off"/>
                </div>
                <div class="form-group col-md-4 input-group-sm">
                    <label for="okpo" title="">ОКПО</label>
                    <input type="text" name="okpo" id="okpo" class="form-control" value="{{$entityObj->okpo}}" required autocomplete="off"/>
                </div>
            </div>
            <div class="form-row text-center">
                <div class="form-group col-md-4 input-group-sm">
                    <label for="okato" title="">ОКАТО/ОКТМО</label>
                    <input type="text" name="okato" id="okato" class="form-control" value="{{$entityObj->okato}}" required autocomplete="off"/>
                </div>
                <div class="form-group col-md-4 input-group-sm">
                    <label for="okogu" title="">ОКОГУ</label>
                    <input type="text" name="okogu" id="okogu" class="form-control" value="{{$entityObj->okogu}}" required autocomplete="off"/>
                </div>
                <div class="form-group col-md-4 input-group-sm">
            ...
            <div class="form-row text-center">
                <div class="form-group col-md-6 input-group-sm">
                    ...
                    <input type="text" name="director" id="director" class="form-control" value="{{$entityObj->director}}" required autocomplete="off"/>
                </div>
                <div class="form-group col-md-6 input-group-sm">
                    <label for="accountant" title="">Главный бухгалтер</label>
                    <input type="text" name="accountant" id="accountant" class="form-control" value="{{$entityObj->accountant}}" required autocomplete="off"/>
                </div>
            </div>
