...
<form action="/payment/addToPay" method="POST">
    @csrf
    ...
    <div class="modal-body">
        <div class="container-fluid">
            <div class="form-group row">
                ...
                <div class="col-sm-4">
                    <input type="text" class="form-control form-control-sm" id="car" name="car" autocomplete="off" value="{{$carObj->nickName}}" readonly />
                </div>
