<div class="row row-table">
                        <div class="col-12">
                            <div class="row">
                                ...
                                <div class="col-2 p-0">{{$insurance->eventModel->dateDocumentText}} по {{$insurance->eventModel->expirationText}}</div>
                                <div class="col-1"><strong>Субьект</strong></div>
                                <div class="col-3 p-0">{{$insurance->eventModel->subject->nickname}}</div>
                                <div class="col-1"><strong>Субьект</strong></div>
                                <div class="col-3 p-0">{{$insurance->eventModel->subjectTo->nickname}}</div>
                                <div class="col-1">
