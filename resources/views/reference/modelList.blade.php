...
@section('content')
    ...
    <div class="row">
        <div class="col-12">
            ...
            <a class="btn btn-ssm btn-outline-success DialogUserMin" title="Добавить список моделей" href="/dialog/addModelGroup?brandId={{$brand->id}}"><i class="fas fa-folder-plus"></i></a>
        </div>
    </div>
